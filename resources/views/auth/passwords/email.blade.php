<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Wachtwoord vergeten - Flexavi</title>
...
@endif
                        <div class="form-group fg-float{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="fg-line">
                                <input id="email" type="email" class="input-sm form-control fg-input" name="email" value="{{ $email or old('email') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn palette-Teal bg"> Send Password reset link</button>
                            </div>
                        </div>
